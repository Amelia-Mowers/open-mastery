...
describe('bundle validation (release gates)', () => {
  ...
  it('stepwise expects: need a confirmation patch, and op expects need a legal move shape', () => {
    ...
    const advisory = new Set(['representation_count', 'worked_missing', 'missing_banner', 'no_expects', 'no_misconceptions', 'no_stepwise', 'lead_ends_quiet', 'form_mismatch'])
    ...
    const advisory2 = new Set(['representation_count', 'worked_missing', 'missing_banner', 'no_expects', 'no_misconceptions', 'no_stepwise', 'lead_ends_quiet', 'form_mismatch'])
